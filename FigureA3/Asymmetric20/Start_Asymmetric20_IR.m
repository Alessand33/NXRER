...
sig  = 7.469279105203383;             % CRRA coefficient 
th   = 4;             % Elasticity of demand across variety
rho  = 2.763597178230768;           % Elasticity of Substitution between Home and Foreign

%rhob = 0.937399727507294;  % beta persistence 
%fi   = 0.002064419081225;  % beta shock from C
%sdb  = 0.001177138054529;  % volatility of shock to beta

rhob = 0;  % beta persistence 
fi   = 0;  % beta shock from C
sdb  = 0;  % volatility of shock to beta

xib  = 0.0001; % Bond cost parameter

rhozc = 0.994646203465340;  % Aggregate Productivity persistence
sdzc  = 0.012337818454907; % SD(Z) adjusted

rhozd = 0.995807443504647;
sdzd = 0.011047780930632;

rhoxic = 0.997971140074426;  % tariff persistence
sdci  = 0.016883668239918; % SD(exi)

rhoxid = 0.999248289183693;  % tariff persistence
sddi  = 0.109210286840344; % SD(exi)

rhoxia = 0;
sdtot = 0.022950218713105;
atotq = -0.110218196515315; % mean correction for totq
aysy = -0.325463553426620;  % mean correction for ysy

zeta = 0.558913873013103; % Shock to theta with RER
...
relF = 1.2; % Foreign size relative to home nominal YfQ/Yh
...
dynare dynare_Asymmetric20_IR;

EXIMN_d_20 = oo_.irfs.EXIMN_exid';
save EXIMN_d_20;