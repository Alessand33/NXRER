...
x = fsolve(@SS_NoAsymmetric,x0,[],xpar);
...
dynare dynare_NoAsymmetric;
load dynare_NoAsymmetric_results;
param_mean = get_posterior_parameters('mean');
