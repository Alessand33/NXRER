...
varexo ezc, ezd, exic, exid, ebf, etot,
       ed0,ed1,ed2,ed3,ed4,ed5,ed6,ed7,ed8,ed9,ed10,ed11,ed12,ed13,ed14,ed15,ed16,
       ec0,ec1,ec2,ec3,ec4,ec5,ec6,ec7,ec8,ec9,ec10,ec11,ec12,ec13,ec14,ec15,ec16;
...
MD = IMR - YRh;
% 61 xic
xic = rhoxic*xic(-1) + sdci*exic/rho + ec0+ec1(-1)+ec2(-2)+ec3(-3)+ec4(-4)+ec5(-5)+ec6(-6)+ec7(-7)+ec8(-8)+ec9(-9)+ec10(-10)+ec11(-11)+ec12(-12)+ec13(-13)+ec14(-14)+ec15(-15)+ec16(-16);
% 62 xid
xid = rhoxid*xid(-1) + sddi*exid/rho + ed0+ed1(-1)+ed2(-2)+ed3(-3)+ed4(-4)+ed5(-5)+ed6(-6)+ed7(-7)+ed8(-8)+ed9(-9)+ed10(-10)+ed11(-11)+ed12(-12)+ed13(-13)+ed14(-14)+ed15(-15)+ed16(-16);
% 63 YSY
YSY = YRf - YRh;
% 64 totq
totq = TOT+q;
